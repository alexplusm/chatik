package ru.server.resource;

import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import ru.server.dao.MessageDao;
import ru.server.dao.UserDao;
import ru.server.model.Message;
import ru.server.model.User;
...
public class ChatResource {
    ...
    public Response login(@QueryParam("name") String name) {
        ...
        message.setUser(userDao.getByName(name));
        message.setValue("[" + name + "]: joined");
